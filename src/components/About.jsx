    ...
    <div name='about' className='max-w-[1000px] mx-auto h-screen bg-[#f1f1e8]'>
      ...
      <div className='flex flex-col justify-center h-full'>
        <div className='text-center pb-8'>
          <p className='text-4xl font-bold inline border-b-4 border-[#a49020] '>About</p>
        </div>
        <div className='max-w-[800px] mx-auto w-full px-8 grid sm:grid-cols-2 gap-5'>
          <div>
            <p className='text-3xl font-bold md:text-right text-[#a49020]'>Hi, I'm Saiful Ajom Khan [ Take a look around ]</p>
          </div>
          <div>
